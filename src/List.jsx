...
function List() {
    const countryList = allCountries.map((country, index) => (
        ...
        >
            ...
            <div className="hidden lg:flex items-center justify-start p-[10px] text-[#D2D5DA]">{country.region}</div>
        </Link>
    ));

    return (
        <section className="col-start-4 col-span-9 row-start-2 grid grid-cols-4 lg:grid-cols-5 w-full">
            {/* Header Row */}
            ...
            <div className="hidden lg:flex items-center justify-start p-[10px] text-[#D2D5DA]">Region</div>
